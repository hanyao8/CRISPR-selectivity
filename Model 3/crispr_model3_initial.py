...
#Duplex free energy
#The free energy of a duplex appear in the following notation
                                                        ...
                                                        for perm_C in next_permutation(seq_C):
                                                            for perm_G in next_permutation(seq_G):
                                                                ...
                                                                for x in range(0,ts_len-1):
                                                                    ...
                                                                    G_tot+=G_dpx[ pos_nt[x] ][ pos_nt[x+1] ][ ts_n[x] ][ ts_n[x+1] ]
                                                                    
                                                                    
                                                                G_tot+=G_init[pos_nt[0]][ts_n[0]]+G_init[pos_nt[ts_len-1]][ts_n[ts_len-1]]
